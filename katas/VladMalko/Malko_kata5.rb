...
def closest(strng)
  ...
  if (closest1.index > closest2.index) and (closest1.weight == closest2.weight)
    closest1, closest2 = closest2, closest1
  end
  # complect and return it
  return [[closest1.weight, closest1.index, closest1.number.to_i],[closest2.weight, closest2.index, closest2.number.to_i]]
end